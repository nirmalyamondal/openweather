...
/**
 * Class OpenweatherCurrentTask
 */
class OpenweatherCurrentTask extends \TYPO3\CMS\Scheduler\Task\AbstractTask
{
    ...
    public function downloadWeatherFile()
    {
        ...
        $current_url    = $conf_settings['current_url'] ? $conf_settings['current_url'] : 'https://api.openweathermap.org/data/2.5/weather';
        $url            = $current_url.'?lat='.$latitude.'&lon='.$longitude.'&appid='.$appid.'&units=metric';
