...
/**
 * Class OpenweatherDailyTask
 */
class OpenweatherDailyTask extends \TYPO3\CMS\Scheduler\Task\AbstractTask
{
    ...
    public function downloadWeatherFile()
    {
        ...
        $daily_url      = $conf_settings['daily_url'] ? $conf_settings['daily_url'] : 'https://api.openweathermap.org/data/2.5/onecall';
        $url            = $daily_url.'?lat='.$latitude.'&lon='.$longitude.'&appid='.$appid.'&units=metric';
